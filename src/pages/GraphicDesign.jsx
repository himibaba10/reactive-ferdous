    ...
    <div>
      ...
      <section className='section max-w-5xl mx-auto mb-10 text-center px-4'>
        ...
        <p className='text-zinc-400 text-lg leading-relaxed mb-6'>
          In today's crowded digital landscape, your visual identity is often the first interaction a potential customer has with your business. A strong, cohesive design language builds trust,
      ...
      <ServiceCards title='Graphic Design Services' description='Comprehensive design solutions tailored to your specific marketing and branding needs.' cards={cards} />
