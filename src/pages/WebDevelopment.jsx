  ...
  return (
    <div>
          ...
          <div className='flex-1 space-y-6 w-full'>
            <div className='bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700/50 hover:bg-zinc-800 transition-colors'>
              ...
              <p className='text-zinc-400'>
                Your website shouldn't just look pretty. We build tailored MERN stack apps and WordPress sites optimized from the ground up to capture leads and drive sales.
              </p>
            </div>
            ...
            <div className='bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700/50 hover:bg-zinc-800 transition-colors'>
              ...
              <p className='text-zinc-400'>
                Faster websites mean lower bounce rates and higher search engine rankings. We write clean, fully SEO-optimized code to ensure maximum visibility and traffic.
              </p>
            </div>
      ...
      <Suspense fallback={<div className='min-h-[200px] flex items-center justify-center text-zinc-500'>Loading...</div>}>
        ...
        <Reviews />
        <FAQ />
        <LeadBanner text='Ready to start your next web project?' buttonText='Discuss Your Project' message="Hi Team, I'm ready to discuss a web development project!" />
        <Contact />
      </Suspense>
    </div>
  );
