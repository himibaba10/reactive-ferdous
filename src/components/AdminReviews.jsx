  ...
  return (
    <div className='min-h-screen bg-zinc-50 dark:bg-zinc-900 p-8 flex flex-col items-center justify-center'>
      <div className='w-full max-w-xl bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-8'>
        ...
        <p className='text-zinc-600 dark:text-zinc-400 mb-8'>Upload a screenshot of a review and paste the URL here to display it in the carousel.</p>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
          <div>
            <label className='block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1'>Review Image URL</label>
            <input
              type='url'
              value={imgUrl}
